...
(function () {
  ...
  const ROOT_IDS = ['pkDuoRoot', 'kcRoot', 'pkfxRoot', 'pkGroupRoot', 'rankingRoot', 'scoreRoot', 'stickerRoot', 'mvpStage', 'lwStage', 'vcRoot', 'cfRoot', 'cfxRoot', 'gmRoot', 'mtRoot', 'dvStage', 'feedRoot'];
